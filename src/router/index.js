...
const routes = [
...

  {
    path: '/index',
    name: 'IndexNgDung',
    component: () => import(/* webpackChunkName: "about" */ '../views/products/nguoidung/IndexNgDung.vue')
  },
  {
    path: '/cart',
    name: 'IndexCart',
    component: () => import(/* webpackChunkName: "about" */ '../views/products/nguoidung/IndexCart.vue')
  },
  {
    path: '/checkout',
    name: 'CheckOut',
    component: () => import(/* webpackChunkName: "about" */ '../views/products/nguoidung/CheckOut.vue')
  }
]
